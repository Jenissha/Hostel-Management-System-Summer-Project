...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images/jenishalogo.png" alt="" class="NavLogo" onclick="rtohome()">
    ...
    <ul class="NavMenu ">
      ...
      <li class="NavItem"><a id="linkcolor2" class="NavLinks" href="#contact">About Us</a></li>
...
<div class="HeroContent">
  ...
  <p class="HeroP">THE Jenisha's HOSTEL</p>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="aboutme.php" class="FooterLink">Developer</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">The Next Hostel © 2024</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/zeenisha.lamichhanex" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/SushilLampard08" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/jenisha_lamichane?igsh=MTA3bmI5MHJycmRm" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/channel/UC33Uz6JqsBuctHXZLJ8Vy4w" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
